...
export default function KanbanColumn({
  ...
  return (
    <div className="flex flex-col min-w-[280px] w-[280px]">
      <div className={`${STAGE_COLORS[stage]} text-white px-3 py-2 rounded-t-xl flex items-center justify-between`}>
      ...
      <div className="bg-claude-hover rounded-b-xl p-2 flex-1 space-y-2 min-h-[200px]">
        ...
        {applications.length === 0 && (
          <p className="text-xs text-claude-tertiary text-center py-8">No applications</p>
        )}
      </div>
    </div>
  );
